...
void __Display_ReadSettings(void *data) {
	...
	Memory_Read(&sneak100.memory, SNEAK100_MEMORY_SETTINGS_ADDRESS, &gui_ptr->settings, sizeof(RobotSettings_StructTypeDef));
...
void __Display_WriteSettings(void *data) {
	...
	Memory_Write(&sneak100.memory, SNEAK100_MEMORY_SETTINGS_ADDRESS, &gui_ptr->settings, sizeof(RobotSettings_StructTypeDef));
}
